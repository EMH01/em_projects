...
and to deploy it, Streamlit/Cloud is used. See the application displayed in [the link](https://emprojects-chat-bot .streamlit.app/). It may be displayed however errors may appear in the case that I try to use my application because the database goes into disabled mode due to disuse.
